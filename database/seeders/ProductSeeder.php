    ...
    public function run(): void
    {
        ...
        DB::table('products')->insert([
           ...
           [
            'name'=>'oppo mobile',
            'price'=>'300',
            'description'=>'a smartphone with 32gb ram and other more features',
            'category'=>'mobile',
           ...
           [
            'name'=>'pasonic tv',
            'price'=>'400',
            'description'=>'a smart tv with other more features',
            'category'=>'tv',
           ...
           [
            'name'=>'soni tv',
            'price'=>'500',
            'description'=>'tv with other more features',
            'category'=>'tv',
           ...
           [
            'name'=>'lg fridge',
            'price'=>'200',
            'description'=>'fridge with other more features',
            'category'=>'fridge',
